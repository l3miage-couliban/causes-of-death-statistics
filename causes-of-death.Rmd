...
plotAmerica <- americaData %>%
  ...
  labs(
    title = "Evolution de la population et du nombre de décès par année en Amérique"
  )
...
plotAsia <- asiaData %>%
  ...
  scale_x_continuous(breaks = seq(1990, 2018, by = 2))+
  labs(
    title = "Evolution de la population et du nombre de décès par année en Asie"
  )
plotAsia
```
...
plotOceania <- oceaniaData %>%
  ...
  scale_x_continuous(breaks = seq(1990, 2018, by = 2)) +
  labs(
    title = "Evolution de la population et du nombre de décès par année en Océanie"
  )
```
...
plotEurope <- europeData %>%
  ...
  scale_x_continuous(breaks = seq(1990, 2018, by = 2))+
  labs(
    title = "Evolution de la population et du nombre de décès par année en Europe"
  )
```
